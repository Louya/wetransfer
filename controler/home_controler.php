...
function upload(){
    ...
    echo $twig->render('info.twig', array('titre'=>$titre, 'info'=>$info, 'nom_fichier'=>$name, "poids"=>$size, 'expediteur'=>$expediteur, 'destinataire'=>$mailDesti, 'message'=>$message, 'erreur'=>$erreur));
